...
namespace UnityEditor.XCodeEditor
{
    public partial class XCProject : System.IDisposable
    {
        ...
        public bool AddOtherCFlags(string flag) { return AddOtherCFlags(new PBXList(flag)); }
        ...
        public bool AddOtherLDFlags(string flag) { return AddOtherLDFlags(new PBXList(flag)); }
        ...
        public bool UpdateBuildKey(string key, string value)
        {
            foreach (KeyValuePair<string, XCBuildConfiguration> buildConfig in buildConfigurations)
            {
        ...
        public bool AddLibrarySearchPaths(string path) { return AddLibrarySearchPaths(new PBXList(path)); }
        ...
        public bool AddHeaderSearchPaths(string path) { return AddHeaderSearchPaths(new PBXList(path)); }
        ...
        public bool AddFrameworkSearchPaths(string path) { return AddFrameworkSearchPaths(new PBXList(path)); }
        ...
        public object GetObject(string guid) { return _objects[guid]; }
        ...
        internal static string AddXcodeQuotes(string path) { return "\"\\\"" + path + "\\\"\""; }
